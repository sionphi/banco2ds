...
while True:
    ...
    def cadastro():
        ...
        while True:
            ...
            if op == 1:
                ...
                try:
                    novo['Cpf'] = int(input("Digite o número do CPF: "))
                except ValueError:
                ...
                novo['Saldo'] = 0
                novo['Extrato'] = []
                novo['Pin'] = int(input("Digite o PIN que será usado todo saque: "))
                print(f'A sua senha é {novo["Senha"]}, guarde bem')
                print(f"Esse é numero da sua conta {novo['Conta']}")
                conta.append(novo)
    ...
    while True:
        opcao = int(input(
            "O que deseja fazer?\n"
            "1 - Cadastro | 2 - Sacar | 3 - Depositar | 4 - Ver extrato | 5 - Ver conta | 6 - Sair "
        ))
        match opcao:
            case 1:
                cadastro()
